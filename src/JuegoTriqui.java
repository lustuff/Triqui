...
public class JuegoTriqui {
    ...
    final static char jugadorCpu_O = jugador_O;
    final static char espacioVacio = ' ';
    final static int conteoGanar = 3;
    // Modos de juego
    final static int jugador_jugador = 1;
    final static int jugaadorCpu = 2;
    ...
    static boolean coordenadasVacias(int y, int x, char[][] tablero) {
        return tablero[y][x] == espacioVacio;
    }
    ...
    static boolean empate(char[][] tableroOriginal) {
        ...
        for (y = 0; y < filas; y++) {
            ...
            for (x = 0; x < columnas; x++) {
                ...
                if (tableroOriginal[y][x] == espacioVacio) {
                    return false;
                }
            }
        }
...
*/
    ...
    */
    ...
    static void iniciarJuego(int modo) {
        if (modo != jugador_jugador && modo != jugaadorCpu && modo != cpu_cpu) {
        ...
        while (true) {
            ...
            if (modo == jugador_jugador || (modo == jugaadorCpu && jugadorActual == jugador_X)) {
                ...
                x--;
                y--;
            } else if (modo == cpu_cpu || jugadorActual == jugadorCpu_O) {
    ...
    public static void main(String[] args) {
        int modo;
        String menu = "1. Humano contra humano\n2. Humano contra CPU (El CPU juega como " + jugadorCpu_O + ")\n3. CPU contra CPU\nElige: ";
